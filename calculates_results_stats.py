...
def calculates_results_stats(results_dic):
    ...
    # changed identation 22.12.2019 - for TEST - Sarath
    ...
    for key in results_dic:
        ...
        #print("hello test line 87")
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            #print("hello test line 90")
    ...
    #print("hello test line 167")
    #print("this prints n_dogs_img" +  str(results_stats_dic['n_dogs_img']))
    #print("hello test line 179")
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/ results_stats_dic['n_dogs_img'])*100.0
    #print("hello test line 181")
    #else:
